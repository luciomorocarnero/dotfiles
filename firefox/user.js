...
// Habilitar personalización mediante userChrome.css y userContent.css
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);

// Forzar aceleración de hardware por capas
user_pref("layers.acceleration.force-enabled", true);

// Habilitar WebRender (motor de renderizado moderno)
user_pref("gfx.webrender.all", true);

// Permitir que archivos SVG hereden propiedades de contexto (útil para temas de iconos)
